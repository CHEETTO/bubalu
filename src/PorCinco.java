 ...
 * donde cada término se obtiene multiplicando el término anterior por 5.
 * 
 * @author cheet
 */
public class PorCinco implements Serie {
    ...
    /**
     * Obtiene el siguiente término de la serie multiplicando el valor actual por 5.
     * 
     * @return El siguiente término de la serie.
     */
    @Override
    public int getSiguiente() {
        this.valorActual = this.valorActual * 5;
        return this.valorActual;
    }

    /**
     * Obtiene el término anterior de la serie dividiendo el valor actual por 5.
     * 
     * @return El término anterior de la serie.
     */
